...
serve(async (req) => {
  ...
  try {
    ...
    const preference = {
      ...
      back_urls: {
        success: `https://b74122dd-46e5-4810-be06-69f354a9f317.lovableproject.com/download?email=${encodeURIComponent(email)}&payment=success`,
        failure: `https://b74122dd-46e5-4810-be06-69f354a9f317.lovableproject.com/download?email=${encodeURIComponent(email)}&payment=failure`,
        pending: `https://b74122dd-46e5-4810-be06-69f354a9f317.lovableproject.com/download?email=${encodeURIComponent(email)}&payment=pending`
      },
